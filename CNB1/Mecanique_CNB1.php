...
<html>
    ...
    <body>
        ...
        <div class="contener_type_épreuve">
            <div class="bloc_type_épreuve"><a href="Quizz_Mécanique_CNB1.php">Quizz</a></div>
            <div class="bloc_type_épreuve"><a href="DS_Mécanique_CNB1.php">DS</a></div>
            <div class="bloc_type_épreuve"><a href="Partiel_Mécanique_CNB1.php">Partiel</a></div>
        </div>
    </body>
