...
<html>
    ...
    <body>
        ...
        <div class="contener_gauche">
            ...
            <div class="bloc_gauche_actuel"><a href="CNB1/Optique_CNB1.php">Optique</a></div>
            <div class="bloc_gauche"><a href="CNB1/Chimie_CNB1.php">Chimie</a></div>
        </div>
        <div class="contener_type_épreuve">
            <div class="bloc_type_épreuve"><a href="Optique_CNB1/Quizz_Optique_CNB1.php">Quizz</a></div>
            <div class="bloc_type_épreuve"><a href="Optique_CNB1/DS_Optique_CNB1.php">DS</a></div>
            <div class="bloc_type_épreuve"><a href="Optique_CNB1/Partiel_Optique_CNB1.php">Partiel</a></div>
        </div>
    </body>
</html>