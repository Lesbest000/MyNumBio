...
if (true === in_array($_SESSION['email'], $admin_email)){
 echo"<div style='float:right;font-weight:bold;width:210px;padding:5px;margin:5px;'>"; 
 echo "<a href='recapitulatif.php'target='_blank' style='color:white'>Voir la liste de tous les dépôts</a>";
 echo"</div>"; 
}
